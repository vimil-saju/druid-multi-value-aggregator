...
import org.apache.druid.extensions.aggregators.multivalue.MultiValueContainsAggregatorFactory;
...
public class MultiValueContainsSqlAggregator implements SqlAggregator
{
  ...
  private static final SqlAggFunction FUNCTION_INSTANCE = new MultiValueContainsSqlAggFunction();
  ...
  public Aggregation toDruidAggregation(PlannerContext plannerContext, RowSignature rowSignature, VirtualColumnRegistry virtualColumnRegistry, RexBuilder rexBuilder, String name, AggregateCall aggregateCall, Project project, List<Aggregation> existingAggregations, boolean finalizeAggregations)
  {
    ...
    AggregatorFactory factory = new MultiValueContainsAggregatorFactory(name, fieldName, value);
    return Aggregation.create(factory);
  }

  private static class MultiValueContainsSqlAggFunction extends SqlAggFunction
  {
    private static final String SIGNATURE = "'" + NAME + "(column, value)'\n";

    MultiValueContainsSqlAggFunction()
    {
      super(
          NAME,
          null,
